...
<head>
  ...
  <title>
    BESTFITS: Career-Path Recommendation System
  </title>
       ...
       <!--        <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink"> 
                  <?php if($_SESSION['ACCOUNT_TYPE']=='Teacher') { ?> 
              <a class="dropdown-item" href="<?php echo WEB_ROOT; ?>admin/modules/inst_front/index.php?view=prof">Profile</a> 
...
<div class="content">
      ...
      <footer class="footer">
        <div class="container-fluid">
          ...
          <div class="copyright" id="copyright">
            ...
            <a href="#" target="_blank">BESTFITS:</a> Career-Path
            <a href="https://www.creative-tim.com" target="_blank">Recommendation System</a>
  ...
  $(document).ready(function(){
      ...
      $('#saveNewFaculty').click(function(){
        
        if( $('#name').val()=='' || $('#address').val()=='' || $('#Gender').val()=='' || $('#civilstats').val()=='' || $('#specialization').val()=='' || $('#empStats').val()=='' || $('#email').val()=='' || $('#pass').val()==''){
            $('.alert-danger').fadeIn();
            return false;
        }
      ...
      $('#saveNewStudent').click(function(){
        ...
        if( $('#idno').val()=='' || $('#lName').val()=='' || $('#fName').val()=='' || $('#mName').val()=='' || $('#email').val()==''){
            $('.alert-danger').fadeIn();
            return false;
        }
      });
      ...
      $('#savestrand').click(function(){
        ...
        if( $('#coursename').val()=='' || $('#coursedesc').val()==''){
            $('.alert-danger').fadeIn();
            return false;
        }
      });
      ...
      $('#savecourse').click(function(){
        ...
        if( $('#subjcode').val()=='' || $('#subjdesc').val()=='' || $('#unit').val()=='' || $('#course').val()=='' || $('#ay').val()=='' ){
            $('.alert-danger').fadeIn();
            return false;
        }
      });
