...
error_reporting(0);
?>
<div class="alert alert-danger" style="display:none;">All field is required field!</div>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <button class="btn btn-primary" name="savefaculty" id="saveNewFaculty" type="submit" ><span class="glyphicon glyphicon-floppy-save"></span> Save</button>
