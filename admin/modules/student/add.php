...
$connections = mysqli_connect ("localhost", "root", "","bestfit_recommendation_system");
...
<div class="alert alert-danger" style="display:none;">Complete all the required field(*) </div>
...
<?php endwhile;?>
    ...
    <fieldset>
      <legend>Secondary Details</legend>
        <label >This section is not required</label> 
    ...
    <div class="form-group">
      <div class="row">
        ...
        <div class="col-md-6" style="text-align: right">
          <button class="btn btn-primary" name="submit" id="saveNewStudent"  type="submit">Save</button>
