...
<div class="panel panel-primary">
	  <div class="panel-heading">
	    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Instructor Student List </h3>
	  </div>
    		...
    		<table class="table" align="center" >	 
				  ...
				  <tbody>				    
			     	...
			     	<!--	<td><?php //echo (isset($cur)) ? $cur->SEMESTER : 'Semester' ;?></td>-->
			     		<strong>Year Level: </strong> <?php echo (isset($cur)) ? $cur->COURSE_DESC : 'Course' ;?><br/>
