<div class="alert alert-danger" style="display:none;">All field is required!</div>
<form class="form-horizontal well span4" action="controller.php?action=add" method="POST">

    <fieldset>
      <legend>New Subject For Student Grades</legend>
      ...
      -->
       ...
       <div class="form-group">
              <div class="col-md-8">
                ...
                <div class="col-md-8">
                  <button class="btn btn-primary" name="savecourse" id="savecourse" type="submit" ><span class="glyphicon glyphicon-floppy-save"></span> Save</button>
