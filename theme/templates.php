      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3 ">
              <div class="site-logo">
            <!--     <a href="<?php echo WEB_ROOT; ?>">BESTFITS: Career-Path Recommendation System</a> -->
              </div>
            </div>
            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation  ml-auto d-none d-lg-block " role="navigation"  style="color: red" >
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  <a href="<?php echo WEB_ROOT; ?>" class="btn btn-primary px-3">Home</a> 
                  <a href="<?php echo WEB_ROOT; ?>index.php?page=3"  class="btn btn-primary px-3">List of Subjects</a>
                  <a href="<?php echo WEB_ROOT; ?>index.php?page=2"  class="btn btn-primary px-3">Student Info</a>
                  <a href="<?php echo WEB_ROOT; ?>logout.php"  class="btn btn-primary px-3">Logout</a> 
                </ul>
              </nav>
            </div>
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p>
          <!--     pagamita laanay kami para la thesis thank you colorlib -->
