...
<div class="site-section">
     ...
     <label style="color: #fb7400;">Please make sure to keep your ID Number. This will serve as your default log-in account to the system!</label>
              ...
              <div class="card-body">
                <form action="student/controller.php?action=add" class="form-horizontal  span9" method="post" autocomplete="off"> 
       ...
       <input class="form-control input-sm" id="bday" name="bday"
              placeholder="Year-Month-Day" type="text">
