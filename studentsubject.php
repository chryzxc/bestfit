		  ...
		  <!-- <form class="form-horizontal span4" action="#.php" method="POST"> -->
					<div class="panel panel-primary">
					  ...
					  <div class="panel-body">
			           ...
			           <div class="container">
				 		<div class="well">
					    <span id="printout">  <div class="panel-heading">
				           ...
				           <table > 
						     ...
						     <tbody>
						     	<tr>
						     		...
						     		<b>School Year : </b><?php echo (isset($sy)) ? $sy->AY : 'STATUS' ;?><br/>
						     	<!--	<td> <?php //echo (isset($sy)) ? $sy->SEMESTER : 'COURSE' ;?></td>-->
						     		<b>Year Level : </b><?php echo (isset($studcourse)) ? $studcourse->COURSE_DESC : 'Department' ;?>
						     		</p></td>
